...
impl Rerouter {
    ...
    pub fn input_of(brick_id: usize) -> WirePort {
        WirePort {
            brick_id,
            component_type: Rerouter::COMPONENT.clone(),
            port_name: Rerouter::INPUT.clone(),
        }
    }
    pub fn output_of(brick_id: usize) -> WirePort {
        WirePort {
            brick_id,
            component_type: Rerouter::COMPONENT.clone(),
            port_name: Rerouter::OUTPUT.clone(),
        }
    }
}
